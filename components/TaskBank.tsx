  ...
  return (
    <div className="flex flex-col h-full bg-slate-900/95 backdrop-blur-2xl border-l border-slate-800 animate-in slide-in-from-right duration-300 shadow-2xl z-50">
      ...
      <div className="p-4 border-b border-slate-800 flex items-center justify-between bg-slate-900/50">
        <div>
          <h2 className="font-bold text-slate-100 font-sans tracking-tight">
            Strategic Task Bank
          </h2>
            ...
            >
              ...
              <div className="flex justify-between items-center mb-2.5">
                <div className="flex gap-2">
                  <span
                    className={`px-2 py-0.5 rounded-md text-[9px] font-black uppercase tracking-[0.1em] border ${THEME_COLORS[task.theme] || "text-slate-400 border-slate-700 bg-slate-800"}`}
                  >
                    {task.theme}
                  </span>
                  <span
